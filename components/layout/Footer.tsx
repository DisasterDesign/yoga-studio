...
const footerLinks = {
  ...
  contact: {
    phone: "+972 58-700-4649",
  },
  instagram: "https://www.instagram.com/fernandariveran/",
};
          ...
          <div>
            ...
            <div className="mt-6">
              <a
                ...
                className="inline-flex items-center gap-2 text-[var(--gold)] hover:text-[var(--teal-bright)] transition-colors duration-300"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
                ...
                <span className="text-sm">@fernandariveran</span>
              </a>
            </div>
          </div>
        </div>
